...
public class ModItemGroups {
    ...
    public static final ItemGroup PINK_GARNET_ITEMS_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().icon(() -> new ItemStack(ModItems.PINK_GARNET))
                    ...
                    .entries((displayContext, entries) -> {
                        ...
                        entries.add(ModItems.COOL_SMITHING_TEMPLATE);
    ...
    public static final ItemGroup COOL_ITEMS = Registry.register(Registries.ITEM_GROUP,
            Identifier.of(TutorialMod.MOD_ID, "cool_items"),
            FabricItemGroup.builder().icon(()  -> new ItemStack(ModItems.WHIP))
                    .displayName(Text.translatable("itemgroup.tutorialmod.cool_items"))
                    .entries((displayContext, entries) -> {
                        entries.add(ModItems.WHIP);

                        entries.add(ModItems.CANCEROUS_REACTOR);
                        ...
                        entries.add(ModItems.COPPERMAN_HELMET);
                        entries.add(ModItems.COPPERMAN_CHESTPLATE);
                        entries.add(ModItems.COPPERMAN_LEGGINGS);
                        entries.add(ModItems.COPPERMAN_BOOTS);

                        entries.add(ModItems.ACTIVATED_COPPERMAN_HELMET);
                        entries.add(ModItems.ACTIVATED_COPPERMAN_CHESTPLATE);
                        entries.add(ModItems.ACTIVATED_COPPERMAN_LEGGINGS);
                        entries.add(ModItems.ACTIVATED_COPPERMAN_BOOTS);
