...
import net.adam.tutorialmod.block.custom.CauliflowerCropBlock;
import net.adam.tutorialmod.block.custom.HoneyBerryBushBlock;
import net.adam.tutorialmod.block.custom.PinkGarnetLampBlock;
...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.registerArmor(((ArmorItem) ModItems.COPPERMAN_HELMET));
        itemModelGenerator.registerArmor(((ArmorItem) ModItems.COPPERMAN_CHESTPLATE));
        itemModelGenerator.registerArmor(((ArmorItem) ModItems.COPPERMAN_LEGGINGS));
        itemModelGenerator.registerArmor(((ArmorItem) ModItems.COPPERMAN_BOOTS));

        itemModelGenerator.registerArmor(((ArmorItem) ModItems.ACTIVATED_COPPERMAN_HELMET));
        itemModelGenerator.registerArmor(((ArmorItem) ModItems.ACTIVATED_COPPERMAN_CHESTPLATE));
        itemModelGenerator.registerArmor(((ArmorItem) ModItems.ACTIVATED_COPPERMAN_LEGGINGS));
        itemModelGenerator.registerArmor(((ArmorItem) ModItems.ACTIVATED_COPPERMAN_BOOTS));

        itemModelGenerator.register(ModItems.PINK_GARNET_HORSE_ARMOR, Models.GENERATED);

        itemModelGenerator.register(ModItems.COOL_SMITHING_TEMPLATE, Models.GENERATED);
        itemModelGenerator.register(ModItems.BAR_BRAWL_MUSIC_DISC, Models.GENERATED);

        itemModelGenerator.register(ModItems.WHIP, Models.HANDHELD_ROD);

        itemModelGenerator.register(ModItems.CANCEROUS_REACTOR, Models.GENERATED);
        ...
        itemModelGenerator.register(ModItems.PHROG_SPAWN_EGG,
                new Model(Optional.of(Identifier.of("item/template_spawn_egg")), Optional.empty()));
        itemModelGenerator.register(ModItems.BLACK_SPAWN_EGG,
                new Model(Optional.of(Identifier.of("item/template_spawn_egg")), Optional.empty()));
    }
}