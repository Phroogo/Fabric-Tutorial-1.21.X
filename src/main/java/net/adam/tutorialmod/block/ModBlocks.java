package net.adam.tutorialmod.block;

import net.adam.tutorialmod.TutorialMod;
import net.adam.tutorialmod.block.custom.*;
import net.adam.tutorialmod.sound.ModSounds;
import net.adam.tutorialmod.world.tree.ModSaplingGenerators;
...
public class ModBlocks {
    ...
    public static final Block CAULIFLOWER_CROP = registerBlockWithoutBlockItem("cauliflower_crop",
            new CauliflowerCropBlock(AbstractBlock.Settings.create().noCollision()
                    .ticksRandomly().breakInstantly().sounds(BlockSoundGroup.CROP).pistonBehavior(PistonBehavior.DESTROY).mapColor(MapColor.WHITE_GRAY)));
