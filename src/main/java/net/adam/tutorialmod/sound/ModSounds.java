package net.adam.tutorialmod.sound;

import net.adam.tutorialmod.TutorialMod;
import net.adam.tutorialmod.item.custom.HammerItem;
...
public class ModSounds {
    ...
    public static final SoundEvent WHIP_USE = registerSoundEvent("whip_use");
    ...
    public static final SoundEvent MANTIS_DEATH_SOUND = registerSoundEvent("mantis_death_sound");
    public static final SoundEvent MANTIS_AMBIENT_SOUND = registerSoundEvent("mantis_ambient_sound");
